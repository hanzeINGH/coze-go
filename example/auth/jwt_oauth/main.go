...
func main() {
	...
	privateKeyBytes, err := ioutil.ReadFile(jwtOauthPrivateKeyFilePath)
	if err != nil {
	...
	*/
	oauth, err := coze.NewJWTOAuthClient(jwtOauthClientID, jwtOauthPublicKeyID, jwtOauthPrivateKey, nil, coze.WithAuthBaseURL(cozeAPIBase))
	if err != nil {
